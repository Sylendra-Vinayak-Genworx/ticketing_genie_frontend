              ...
              {isLoading
                ...
                : tickets.map(ticket => (
                  <tr key={ticket.ticket_id}
                    ...
                    <td className="px-4 py-3"><SLATimer dueAt={ticket.resolution_due_at} status={ticket.status} isBreached={ticket.is_breached}   resolutionSlaCompletedAt={ticket.resolution_sla_completed_at}  resolvedAt={ticket.resolved_at}compact /></td>
                    {canSeeAll && (
