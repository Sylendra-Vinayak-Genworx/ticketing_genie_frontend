              ...
              {isLoading
                ...
                : filteredList.map(ticket => (
                  <tr key={ticket.ticket_id} className="table-row cursor-pointer hover:bg-amber-50/40 transition-colors" onClick={() => navigate(`/tickets/${ticket.ticket_id}`)}>
                    ...
                    <td className="px-4 py-3"><SLATimer isBreached={ticket.is_breached} dueAt={ticket.resolution_due_at} status={ticket.status} resolutionSlaCompletedAt={ticket.resolution_sla_completed_at} resolvedAt={ticket.resolved_at} updatedAt={ticket.updated_at} compact /></td>
