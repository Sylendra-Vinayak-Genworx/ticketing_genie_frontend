    ...
    modalMode === 'delete' ? (
      <>
        ...
        <button
          ...
          disabled={saving}
          className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-red-600 text-white hover:bg-red-700 disabled:opacity-50 transition-colors"
        >
                    ...
                    <tr key={p.product_id} className="table-row">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          ...
                          >
                            <Package
                              className={`w-4 h-4 ${p.is_active ? 'text-blue-600' : 'text-gray-400'}`}
                            />
                          </div>
                          <span
                            className={`font-medium ${p.is_active ? 'text-gray-900' : 'text-gray-400'}`}
                          >
                            {p.name}
                          </span>
                        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g. bookmyticket, mobile-app, payments…"
                maxLength={100}
                autoFocus
              />
            </div>
            <div>
              ...
              <textarea
                ...
                rows={3}
                placeholder="Optional short description of this product…"
                maxLength={500}
              />
            </div>
            <div className="flex items-center gap-3 pt-1">
              ...
              <span className="text-sm font-medium text-gray-700">
                {form.is_active
                  ...
                  : 'Inactive — hidden from ticket creation'}
              </span>
            </div>
          </div>
        )}
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-4 bg-red-50 border border-red-200 rounded-lg">
              ...
              <p className="text-sm text-red-800">
                Are you sure you want to permanently delete <strong>"{selected.name}"</strong>? This
                action cannot be undone.
              </p>
            </div>
            <p className="text-sm text-gray-500">
              Consider deactivating the product instead if you want to hide it from ticket creation
