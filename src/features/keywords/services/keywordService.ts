...
import type {
  KeywordRule,
  CreateKeywordRuleRequest,
  UpdateKeywordRuleRequest,
  PaginatedResponse,
} from '@/types';
...
export const keywordService = {
  async listRules(params?: {
    ...
    page_size?: number;
    is_active?: boolean;
  }): Promise<PaginatedResponse<KeywordRule>> {
    const res = await ticketingApi.get<PaginatedResponse<KeywordRule>>('/keyword-rules', {
      params,
    });
    return res.data;
  },
